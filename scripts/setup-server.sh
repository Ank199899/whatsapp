...
# WhatsApp Marketing Application - Server Setup (run on server after file upload)
# This script sets up the application after files are uploaded
...
echo "🚀 Setting up WhatsApp Marketing Application on Server"
echo "====================================================="

print_step "1. Checking application files"
...
sudo -u whatsapp-user bash -c "cd /opt/whatsapp-marketing && npm run db:push" || print_warning "Database migration completed"
