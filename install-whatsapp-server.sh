...
# WhatsApp Marketing Application - Complete Server Installation Script
# Server: 192.168.29.147
# User: admin1
# Password: admin

set -e  # Exit on any error

echo "🚀 Starting WhatsApp Marketing Application Installation..."
echo "=================================================="
...
if [[ $EUID -eq 0 ]]; then
   print_error "This script should not be run as root. Please run as admin1 user."
   exit 1
fi
...
print_step "8. Application Setup Preparation"
print_status "Application files need to be uploaded to /opt/whatsapp-marketing"
print_warning "Please upload your WhatsApp application files to the server now."
print_warning "You can use SCP, SFTP, or any file transfer method."

echo ""
echo "📋 NEXT STEPS:"
echo "=============="
echo "1. Upload your application files to: /opt/whatsapp-marketing"
echo "2. Run the application setup script: ./setup-application.sh"
echo ""
echo "🔧 Server Information:"
echo "====================="
echo "Server IP: 192.168.29.147"
echo "Application Directory: /opt/whatsapp-marketing"
echo "Database: whatsapp_marketing"
echo "Database User: whatsapp_user"
echo "Database Password: WhatsApp@2024!"
echo ""
